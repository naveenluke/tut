...
## Table of contents
1. [Introduction](IGV-Tutorial.md#introduction)
  1. [Description of the lab](IGV-Tutorial.md#description-of-the-lab)
  2. [Requirements](IGV-Tutorial.md#requirements)
  3. [Compatibility](IGV-Tutorial.md#compatibility)
  4. [Data Set for IGV](IGV-Tutorial.md#compatibility)
2. [Visualization Part 1: Getting familiar with IGV](IGV-Tutorial.md#visualization-part-1-getting-familiar-with-igv)
  1. [Get familiar with the interface](IGV-Tutorial.md#get-familiar-with-the-interface)
    1. [Load a Genome and Data Tracks](IGV-Tutorial.md#load-a-genome-and-some-data-tracks)
    2. [Navigation](IGV-Tutorial.md#navigation)
  2. [Region Lists](IGV-Tutorial.md#region-lists)
  3. [Loading Read Alignments](IGV-Tutorial.md#loading-read-alignments)
  4. [Visualizing read alignments](IGV-Tutorial.md#visualizing-read-alignments)
3. [Visualization Part 2: Inspecting SNPs, SNVs, and SVs](IGV-Tutorial.md#visualization-part-2-inspecting-snps-snvs-and-svs-)
  1. [Neighbouring somatic SNV and germline SNP](IGV-Tutorial.md#neighbouring-somatic-snv-and-germline-snp)
  2. [Homopolymer repeat with indel](IGV-Tutorial.md#homopolymer-repeat-with-indel)
  3. [Coverage by GC](IGV-Tutorial.md#coverage-by-gc)
  4. [Heterozygous SNPs on different alleles](IGV-Tutorial.md#heterozygous-snps-on-different-alleles)
  5. [Low mapping quality](IGV-Tutorial.md#low-mapping-quality)
  6. [Homozygous deletion](IGV-Tutorial.md#homozygous-deletion)
  7. [Mis-alignment](IGV-Tutorial.md#mis-alignment)
  8. [Translocation](IGV-Tutorial.md#translocation)
4. [Visualization Part 3: Automating Tasks in IGV](IGV-Tutorial.md#visualization-part-3-automating-tasks-in-igv)
